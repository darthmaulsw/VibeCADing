def mkprompt(p: str) -> str:
    return f"""
        ...
        Ensure that the prompt includes an instruction to use MCAD libraries built into OpenSCAD whenever appropriate; moreover, all items must be attached together and there should not be any random floating bodies. 
