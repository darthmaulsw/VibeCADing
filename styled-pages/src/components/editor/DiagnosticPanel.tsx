  ...
  return (
    <div className="absolute bottom-6 right-6">
      <svg width="280" height="150" className="absolute bottom-0 right-0">
        <line x1="280" y1="30" x2="240" y2="30" stroke="#00D4FF" strokeWidth="1" opacity="0.4" />
        <circle cx="240" cy="30" r="3" fill="#00D4FF" opacity="0.8" />

        <line x1="280" y1="70" x2="240" y2="70" stroke="#00D4FF" strokeWidth="1" opacity="0.4" />
        <circle cx="240" cy="70" r="3" fill="#00D4FF" opacity="0.8" />

        <line x1="280" y1="110" x2="240" y2="110" stroke="#00D4FF" strokeWidth="1" opacity="0.4" />
        <circle cx="240" cy="110" r="3" fill="#00D4FF" opacity="0.8" />

        <line x1="240" y1="30" x2="240" y2="110" stroke="#00D4FF" strokeWidth="1" opacity="0.2" strokeDasharray="2 2" />
      </svg>

      <div className="font-mono text-xs" style={{ color: '#00D4FF', marginRight: '50px', textAlign: 'right' }}>
      ...
      <div
        ...
        style={{ color: '#00D4FF', marginRight: '50px' }}
      >
        SYSTEM DIAGNOSTICS
      </div>
    </div>
