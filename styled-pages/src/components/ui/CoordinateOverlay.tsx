  ...
  return (
    <div className="absolute top-1/2 right-6 transform -translate-y-1/2">
      <svg width="300" height="200" className="absolute top-0 right-0">
        <line x1="0" y1="40" x2="40" y2="40" stroke="#00D4FF" strokeWidth="1" opacity="0.4" />
        <circle cx="40" cy="40" r="3" fill="#00D4FF" opacity="0.8" />

        <line x1="0" y1="100" x2="40" y2="100" stroke="#00D4FF" strokeWidth="1" opacity="0.4" />
        <circle cx="40" cy="100" r="3" fill="#00D4FF" opacity="0.8" />

        <line x1="0" y1="160" x2="40" y2="160" stroke="#00D4FF" strokeWidth="1" opacity="0.4" />
        <circle cx="40" cy="160" r="3" fill="#00D4FF" opacity="0.8" />

        <line x1="40" y1="40" x2="40" y2="160" stroke="#00D4FF" strokeWidth="1" opacity="0.2" strokeDasharray="2 2" />
      </svg>

      <div className="font-mono text-xs" style={{ color: '#00D4FF', marginLeft: '50px' }}>
      ...
      <div
        ...
        style={{ color: '#00D4FF', marginLeft: '50px' }}
      >
        GLOBAL COORDINATES
      </div>
    </div>
